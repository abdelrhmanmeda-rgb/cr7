...
const StatisticsManager = () => {
  ...
  useEffect(() => {
    const fetchRealStats = async () => {
      try {
        ...
        const res = await fetch('https://cr7-git-main-abdelrhmanmeda-rgbs-projects.vercel.app/api/statistics', {
  ...
  const handleResetStats = async () => {
    ...
    try {
      const token = await auth.currentUser?.getIdToken();
      const res = await fetch('https://cr7-git-main-abdelrhmanmeda-rgbs-projects.vercel.app/api/statistics/reset', {
        method: 'POST',
        headers: { 'Authorization': `Bearer ${token}` }
      });
      if (res.ok) {
...
const ResultsManager = () => {
  ...
  const fetchResults = async () => {
    try {
      const res = await fetch('https://cr7-git-main-abdelrhmanmeda-rgbs-projects.vercel.app/api/results');
      const data = await res.json();
  ...
  const handleUpload = async (e: React.FormEvent) => {
    ...
    try {
      const token = await auth.currentUser?.getIdToken();
      const res = await fetch('https://cr7-git-main-abdelrhmanmeda-rgbs-projects.vercel.app/api/results/upload', { 
        method: 'POST', 
        headers: { 'Authorization': `Bearer ${token}` },
        body: formData 
      });
  ...
  const handleDelete = async (id?: string) => {
    ...
    try {
      const token = await auth.currentUser?.getIdToken();
      const res = await fetch(`https://cr7-git-main-abdelrhmanmeda-rgbs-projects.vercel.app/api/results/${id}`, { 
        method: 'DELETE',
        headers: { 'Authorization': `Bearer ${token}` }
      });
      const data = await res.json();
...
const BotsManager = () => {
  ...
  const fetchBots = async () => {
    try {
      const res = await fetch('https://cr7-git-main-abdelrhmanmeda-rgbs-projects.vercel.app/api/bots');
      const data = await res.json();
  ...
  const handleAddOrEditBot = async (e: React.FormEvent) => {
    ...
    const url = editingId 
      ? `https://cr7-git-main-abdelrhmanmeda-rgbs-projects.vercel.app/api/bots/${editingId}` 
      : 'https://cr7-git-main-abdelrhmanmeda-rgbs-projects.vercel.app/api/bots/add';
  ...
  const handleDelete = async (id?: string) => {
    ...
    try {
      const token = await auth.currentUser?.getIdToken();
      const res = await fetch(`https://cr7-git-main-abdelrhmanmeda-rgbs-projects.vercel.app/api/bots/${id}`, { 
        method: 'DELETE',
        headers: { 'Authorization': `Bearer ${token}` }
      });
      if (res.ok) fetchBots();
...
const SubscriptionsManager = () => {
  ...
  const fetchPlans = async () => {
    try {
      const res = await fetch('https://cr7-git-main-abdelrhmanmeda-rgbs-projects.vercel.app/api/subscriptions');
      const data = await res.json();
  ...
  const handleAddOrEditPlan = async (e: React.FormEvent) => {
    ...
    const url = editingId ? `https://cr7-git-main-abdelrhmanmeda-rgbs-projects.vercel.app/api/subscriptions/${editingId}` : 'https://cr7-git-main-abdelrhmanmeda-rgbs-projects.vercel.app/api/subscriptions/add';
    const method = editingId ? 'PUT' : 'POST';
  ...
  const handleDelete = async (id?: string) => {
    ...
    try {
      const token = await auth.currentUser?.getIdToken();
      const res = await fetch(`https://cr7-git-main-abdelrhmanmeda-rgbs-projects.vercel.app/api/subscriptions/${id}`, { 
        method: 'DELETE',
        headers: { 'Authorization': `Bearer ${token}` }
      });
...
const BlogManager = () => {
  ...
  const fetchPosts = async () => {
    try {
      const res = await fetch('https://cr7-git-main-abdelrhmanmeda-rgbs-projects.vercel.app/api/blog');
      const data = await res.json();
  ...
  const handleAddPost = async (e: React.FormEvent) => {
    ...
    try {
      const token = await auth.currentUser?.getIdToken();
      const res = await fetch('https://cr7-git-main-abdelrhmanmeda-rgbs-projects.vercel.app/api/blog/add', { 
        method: 'POST', 
        headers: { 'Authorization': `Bearer ${token}` },
        body: form 
      });
  ...
  const handleDelete = async (id?: string) => {
    ...
    try {
      const token = await auth.currentUser?.getIdToken();
      const res = await fetch(`https://cr7-git-main-abdelrhmanmeda-rgbs-projects.vercel.app/api/blog/${id}`, { 
        method: 'DELETE',
        headers: { 'Authorization': `Bearer ${token}` }
      });
  ...
  const handleDeleteComment = async (postId: string, commentId: string) => {
    ...
    try {
      const token = await auth.currentUser?.getIdToken();
      const res = await fetch(`https://cr7-git-main-abdelrhmanmeda-rgbs-projects.vercel.app/api/blog/${postId}/comment/${commentId}`, { 
        method: 'DELETE',
        headers: { 'Authorization': `Bearer ${token}` }
      });
      if (res.ok) {
...
const SettingsManager = () => {
  ...
  const fetchSettings = async () => {
    try {
      const res = await fetch('https://cr7-git-main-abdelrhmanmeda-rgbs-projects.vercel.app/api/settings');
      const data = await res.json();
      if (data.success && data.data) {
        setSettings({
