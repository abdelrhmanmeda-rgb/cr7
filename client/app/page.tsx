...
export default function App() {
  ...
  const trackUserAction = async (actionType: string, itemName?: string, price?: string | number) => {
    try {
      await fetch('https://cr7-4ax2dgt9n-abdelrhmanmeda-rgbs-projects.vercel.app/api/statistics/track', {
        method: 'POST',
  ...
  const fetchResults = useCallback(async (retries = 5, delay = 1000) => {
    try {
      const response = await fetch('https://cr7-4ax2dgt9n-abdelrhmanmeda-rgbs-projects.vercel.app/api/results');
  ...
  const fetchBots = useCallback(async (retries = 3, delay = 1000) => {
    try {
      const response = await fetch('https://cr7-4ax2dgt9n-abdelrhmanmeda-rgbs-projects.vercel.app/api/bots');
      const data = await response.json();
  ...
  const fetchPlans = useCallback(async (retries = 3, delay = 1000) => {
    try {
      const response = await fetch('https://cr7-4ax2dgt9n-abdelrhmanmeda-rgbs-projects.vercel.app/api/subscriptions');
      const data = await response.json();
  ...
  const fetchSettings = useCallback(async (retries = 3, delay = 1000) => {
    try {
      const response = await fetch('https://cr7-4ax2dgt9n-abdelrhmanmeda-rgbs-projects.vercel.app/api/settings');
      const data = await response.json();
  ...
  const fetchPosts = useCallback(async (retries = 3, delay = 1000) => {
    try {
      const response = await fetch('https://cr7-4ax2dgt9n-abdelrhmanmeda-rgbs-projects.vercel.app/api/blog');
      const data = await response.json();
  ...
  const handleLike = async (postId: string) => {
    ...
    try {
      const res = await fetch(`https://cr7-4ax2dgt9n-abdelrhmanmeda-rgbs-projects.vercel.app/api/blog/${postId}/like`, {
        method: 'POST',
        headers: { 
  ...
  const handleAddComment = async (postId: string) => {
    ...
    try {
      const res = await fetch(`https://cr7-4ax2dgt9n-abdelrhmanmeda-rgbs-projects.vercel.app/api/blog/${postId}/comment`, {
        method: 'POST',
        headers: { 
          'Accept': 'application/json',
          'Content-Type': 'application/json' 
